    ...
    content: {
        ...
        en: {
            ...
            steps: [
                ...
                { title: "Step 5", desc: "Enter tour number" }
            ]
        },
        ar: {
            ...
            steps: [
                ...
                { title: "خطوة 5", desc: "أدخل رقم الجولة" }
            ]
        },
        bg: {
            ...
            steps: [
                ...
                { title: "Стъпка 5", desc: "Въведете номер на обиколка" }
            ]
        },
        cs: {
            ...
            steps: [
                ...
                { title: "Krok 5", desc: "Zadejte číslo prohlídky" }
            ]
        },
        el: {
            ...
            steps: [
                ...
                { title: "Βήμα 5", desc: "Εισαγάγετε αριθμό περιήγησης" }
            ]
        },
        es: {
            helpBtn: "Solicitar ayuda", helpSent: "¡La ajuda está en camino!", placeTruckHere: "Coloque el camión aquí", next: "Siguiente", back: "Atrás", finish: "Finalizar",
            ...
            steps: [
                ...
                { title: "Paso 5", desc: "Introducir número de tour" }
            ]
        },
        fr: {
            ...
            steps: [
                ...
                { title: "Étape 5", desc: "Entrer le numéro de tour" }
            ]
        },
        hu: {
            ...
            steps: [
                ...
                { title: "5. lépés", desc: "Adja meg a túra számát" }
            ]
        },
        it: {
            ...
            steps: [
                ...
                { title: "Passo 5", desc: "Inserisci il numero del tour" }
            ]
        },
        nl: {
            ...
            steps: [
                ...
                { title: "Stap 5", desc: "Voer het tournummer in" }
            ]
        },
        pl: {
            ...
            steps: [
                ...
                { title: "Krok 5", desc: "Wprowadź numer trasy" }
            ]
        },
        pt: {
            ...
            steps: [
                ...
                { title: "Passo 5", desc: "Insira o número da excursão" }
            ]
        },
        ro: {
            ...
            steps: [
                ...
                { title: "Pasul 5", desc: "Introduceți numărul turneului" }
            ]
        },
        ru: {
            ...
            steps: [
                ...
                { title: "Шаг 5", desc: "Введите номер тура" }
            ]
        },
        sk: {
            ...
            steps: [
                ...
                { title: "Krok 5", desc: "Zadajte číslo prehliadky" }
            ]
        },
        tr: {
            ...
            steps: [
                ...
                { title: "Adım 5", desc: "Tur numarasını girin" }
            ]
        },
        uk: {
            ...
            steps: [
                ...
                { title: "Крок 5", desc: "Введіть номер туру" }
            ]
        }
    },
